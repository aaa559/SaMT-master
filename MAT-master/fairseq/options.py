    ...
    for registry_name, REGISTRY in REGISTRIES.items():
        ...
        if choice is not None:
            ...
            if hasattr(cls, 'add_args'):
                cls.add_args(parser)
    if hasattr(args, 'criterion0'):
        CRITERION_REGISTRY[args.criterion0].add_args(parser)
    if hasattr(args, 'criterion1'):
...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--alpha', default=0.5, type=float, metavar='D',
                        help='hyper parameter for loss1')
...
def add_model_args(parser):
    ...
    group.add_argument('--criterion0', default='cross_entropy', metavar='CRIT',

                       help='Training Criterion')
    group.add_argument('--criterion1', default='kl_loss', metavar='CRIT',
